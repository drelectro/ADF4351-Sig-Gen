...
//ADF4351
#define ADF4351_LD   PA8    ///< Ard Pin for Lock Detect **Not Used - LED only**

//#define ADF4351_CE   PB12  ///< Ard Pin for Chip Enable
#define ADF4351_SS   PB12  ///< Ard Pin for SPI ADF Select **PIN_LE**
#define ADF4351_MOSI PB15  ///< Ard Pin for SPI MOSI
#define ADF4351_MISO PB14  ///< Ard Pin for SPI MISO
#define ADF4351_SCK  PB13  ///< Ard Pin for SPI CLK
